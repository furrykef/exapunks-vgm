# Modified from https://raw.githubusercontent.com/cdodd/vgmparse/master/vgmparse/__init__.py
import gzip
import struct
import sys
...
class Parser:
    ...
    def parse_commands(self):
        ...
        while True:
            ...
            # KEF'S ADDITION
                ...
                raise ValueError("vgmparse: Unrecognized command: 0x%02X" % command[0])
    ...
    def validate_vgm_version(self):
        # KEF'S HACK: Many VGMs are of a later version and still work fine
        # So we're disabling this routine
        return
